...
const USER_LORD = "C:\\Users\\Nandheesaprasad\\.gemini\\antigravity-ide\\brain\\4d15bc15-2ae2-43f8-9dc8-e3aeeec3a9c5\\.user_uploaded\\media_1789364766184.jpg";
...
console.log('--- 8x10 Kodak Print & Asset Setup ---');

// 1. Ensure directories exist
[ASSETS_DIR, path.join(ROOT_DIR, 'docs', 'assets')].forEach(dir => {
...
if (fs.existsSync(USER_LORD)) {
  ...
  console.log('✅ Copied Lord Nandhish caricature into public/assets/ and docs/assets/');
}
...
console.log('Done! Now run create-8x10-kodak-print.bat or open public/kodak-print.html in your browser.');
